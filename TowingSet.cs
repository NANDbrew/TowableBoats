...
namespace TowableBoats
{
    internal class TowingSet : MonoBehaviour
    {
        ...
        static readonly object[] brig0 = { "bollard_stern_left", new Vector3(-14.9f, 4.39f, 2.23f), new Quaternion(0.7071068f, 0f, 0f, 0.7071068f) }; // 90, 0, 0
        static readonly object[] brig1 = { "bollard_stern_right", new Vector3(-14.9f, 4.39f, -2.23f), new Quaternion(0.7071068f, 0f, 0f, 0.7071068f) };
        static readonly object[] brig2 = { "bollard_mid_aft_left", new Vector3(-2.3f, 3.51f, 3.27f), new Quaternion(0.7071068f, 0f, 0f, -0.7071068f) }; // 270, 0, 0
        static readonly object[] brig3 = { "bollard_mid_aft_right", new Vector3(-2.3f, 3.51f, -3.27f), new Quaternion(0.7071068f, 0f, 0f, -0.7071068f) };
        static readonly object[] brig4 = { "bollard_mid_fore_left", new Vector3(6f, 3.62f, 2.92f), new Quaternion(0.7071068f, 0f, 0f, -0.7071068f) };
        static readonly object[] brig5 = { "bollard_mid_fore_right", new Vector3(6f, 3.62f, -2.92f), new Quaternion(0.7071068f, 0f, 0f, -0.7071068f) };
        static readonly Array[] brigBollards = { brig0, brig1, brig2, brig3, brig4, brig5 };

        static readonly object[] sanbuq0 = { "bollard_stern_left", new Vector3(-11.5f, 3.33f, 2.22f), new Quaternion(0.7071068f, 0f, 0f, -0.7071068f) }; // 270, 0, 0
        static readonly object[] sanbuq1 = { "bollard_stern_right", new Vector3(-11.5f, 3.33f, -2.22f), new Quaternion(0.7071068f, 0f, 0f, -0.7071068f) };
        ...
        static readonly object[] sanbuq4 = { "bollard_mid_fore_left", new Vector3(4.7f, 2.34f, 2.21f), new Quaternion(0.706676f, -0.0246777f, 0.0246777f, -0.706676f) }; // 270, 4, 0
        static readonly object[] sanbuq5 = { "bollard_mid_fore_right", new Vector3(4.7f, 2.34f, -2.21f), new Quaternion(0.706676f, 0.0246777f, -0.0246777f, -0.706676f) }; // 270, -4, 0
        ...
        static readonly object[] junk2 = { "bollard_mid_aft_left", new Vector3(1.5f, 1.04f, 2.55f), new Quaternion(0.7071068f, 0f, 0f, -0.7071068f) };
        static readonly object[] junk3 = { "bollard_mid_aft_right", new Vector3(1.5f, 1.04f, -2.55f), new Quaternion(0.7071068f, 0f, 0f, -0.7071068f) };
        static readonly object[] junk4 = { "bollard_mid_fore_left", new Vector3(8.44f, 1.3f, 1.88f), new Quaternion(0.7010574f, -0.092296f, 0.092296f, -0.7010574f) }; //270, 15, 0
        static readonly object[] junk5 = { "bollard_mid_fore_right", new Vector3(8.44f, 1.3f, -1.88f), new Quaternion(0.7010574f, 0.092296f, -0.092296f, -0.7010574f) }; //270, -15, 0
