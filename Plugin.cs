...
namespace TowableBoats
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            smallBoats = Config.Bind("Settings", "Small boats can tow", true, new ConfigDescription("Add anchor points to small boats (requires a restart to take effect)", null, new ConfigurationManagerAttributes { IsAdvanced = false, Order = 1}));
        }
    }
}
